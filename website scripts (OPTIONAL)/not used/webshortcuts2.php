...
return $url;
	...
	$url_final = str_replace("http://cola-team.com/franug/webshortcuts2.php?web=", "", $url2);
	$url_final2 = str_replace("http://cola-team.com/franug/webshortcuts2.php?web=", "", $url_final);
